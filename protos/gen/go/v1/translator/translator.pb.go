...
func (x *TranslateRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *TranslateRequest) GetHeader() string {
	if x != nil {
		return x.Header
	}
	return ""
...
func (x *TranslateRequest) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *TranslateRequest) GetIsSponsored() bool {
	if x != nil {
		return x.IsSponsored
	}
	return false
}
...
func (x *TranslateResponse) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *TranslateResponse) GetHeader() string {
	if x != nil {
		return x.Header
	}
	return ""
...
func (x *TranslateResponse) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *TranslateResponse) GetIsSponsored() bool {
	if x != nil {
		return x.IsSponsored
	}
	return false
...
var file_v1_translator_translator_proto_rawDesc = []byte{
	...
	0x91, 0x01, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x18,
	...
	0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x6f, 0x72, 0x65, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x53, 0x70, 0x6f, 0x6e, 0x73, 0x6f,
	0x72, 0x65, 0x64, 0x22, 0x92, 0x01, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74,
	...
	,
